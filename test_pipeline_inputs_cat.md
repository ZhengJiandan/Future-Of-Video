...
- 写实猫咪特工风: [backend/sql/seed_cat_profiles.sql](/Users/zhenglei/git/long-video-master/backend/sql/seed_cat_profiles.sql)
- 可爱猫咪短片风: [backend/sql/seed_cute_cat_profiles.sql](/Users/zhenglei/git/long-video-master/backend/sql/seed_cute_cat_profiles.sql)

适用目标：

- 测试“用户输入 -> 角色分析 -> 剧本生成 -> 场景拆分 -> 首帧生成 -> 视频生成 -> 合成”整条链路
